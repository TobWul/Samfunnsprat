<template>
  ...
  >
    ...
    <template v-else-if="name === 'pending'">
      <path d="M6 .75a1.5 1.5 0 00-1.5 1.5v2.367a7.5 7.5 0 0015 0V2.25A1.5 1.5 0 0018 .75z"/><path class="a" d="M6 23.25a1.5 1.5 0 01-1.5-1.5v-2.367a7.5 7.5 0 0115 0v2.367a1.5 1.5 0 01-1.5 1.5zM5.477 8.25h13.046"/><path d="M18.548 23.147C17.264 20.451 14.813 18 12 18s-5.264 2.451-6.548 5.147"/>
    </template>
    <template v-else-if="name === 'user'">
      <circle cx="12" cy="12" r="11.25"/><path d="M7.5 17.007a6.68 6.68 0 009 0M6.75 6.75V9M17.25 6.75V9M12 6.75V12a1.5 1.5 0 01-1.5 1.5h-.75"/>
    </template>
  </svg>
</template>
